...
private:
    vrv::Transpose::Interval keydiff2Interval(int oldFifths, int newFifths,
                                              TransposeDirection dir = TransposeDirection::CLOSEST);
    static void transposeTpc(int tpc, vrv::Transpose::Interval interval, bool useDoubleSharpsFlats, int &step,
                             int &alter);
